	...
	function bringId() {
		...
		$.ajax({
            ...
            success : function(data) {
            	...
            	id = new String(data.user_id);
            	
            	if ((data.user_id) != null && (data.user_id) != "") {
            		window.location.href = "/hotel/view/member/idfin.jsp?user_id="+id;
                  
               } else{                
            	   $("#button1").click(function(){
               		$("#btn").dialog({
               			  title:"아이디 찾기 실패!!", width:250, 
...
<form action="/hotel/mid" method="post" id="joinform">
<fieldset class="f11">
<legend>
				<span class="span1">아이디 찾기</span>
			</legend>
	...
	<table >
	 ...
	 <div class="btnCenter">
				<a  id="popup" class='idFind' ></a>
				<input id="button1" type="button" value="아이디 찾기" onclick="bringId();" >
				<p>
				<a href="/hotel/view/member/pwdFind.jsp" ><input id="button2" type="button" value="비밀번호 찾기" /></a>
