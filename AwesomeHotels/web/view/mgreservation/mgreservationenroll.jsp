...
<body>
	...
	<div class="scenter">
	<div class="padd"></div>
	<form action="/hotel/resmodify?hotel_no=<%=list.getHotel_no()%>" method="post" name="f2">
		
		
		<span class="chetext">예약 아이디 : </span><input type="text" class="id" name="userid">
	...
	<div class="padd"></div>
	<form action="/hotel/resmodify?hotel_no=<%=list.getHotel_no()%>&hotel_name=<%=loginUser.getHotel_name() %>" method="post" name="f2">
		<table class="revervet">
			...
			<tr>
				...
				<td style="background: #00AEF0; color: white; border-radius: 5px;"><input
					type="text" id="price" class="p124" readonly name="price" value="<%= list.getHotel_price()%>">
			...
			<tr style="width: 100px; height: 100px;">
				...
				<td><input type="hidden" name="checkin" class="checkin2">
					...
					type="hidden" name="people" class="pel2"> <input
					type="submit" id="button1" value="예약하기"></td>
			</tr>
		</table>
