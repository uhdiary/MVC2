...
public class MyReservationDetail extends Reservation implements Serializable{
	...
	public MyReservationDetail(){
		
	}

	public MyReservationDetail(String hotel_name, int hotel_no, String hotel_address, String hotel_info,
			String hotel_link, String hotel_fac1, String hotel_fac2, String hotel_fac3, String hotel_fac4,
			String hotel_start_time, String hotel_end_time, String hotel_travel, int hotel_price) {
		super();
